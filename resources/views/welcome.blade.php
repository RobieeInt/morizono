{{-- <x-layouts.app :title="'Morizono'">
    <section class="p-10 text-center">
        <h1 class="text-3xl mb-2">Morizono</h1>
        <p class="opacity-80">Landing page simple. Bebas ribet, fokus dapet lead.</p>
    </section>

    <section class="p-10">
        <h2 class="text-2xl mb-4">Kontak</h2>
